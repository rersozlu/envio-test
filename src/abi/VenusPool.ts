...
export const VenusPoolABI: Abi = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "_newReduceReservesBlockOrTimestampDelta", type: "uint256" },
    ],
